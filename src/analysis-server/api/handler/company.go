...
func (ch *CompanyHandlers) ListCompany(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		gLogger.ErrorContext(r.Context(), "[company/Listcompany] [HttpRequestParse: %v]", err)
	...
	if ccErr != nil {
		gLogger.WarnContext(r.Context(), "[company/ListCompany/ServerHTTP] [ComService.ListCompany: %s]", ccErr.Detail())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
...
func (ch *CompanyHandlers) GetCompany(w http.ResponseWriter, r *http.Request) {
	...
	if ccErr != nil {
		gLogger.WarnContext(r.Context(), "[company/GetCompanyById/ServerHTTP] [ComService.GetCompanyById: %s]", ccErr.Detail())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
...
func (ch *CompanyHandlers) CreateCompany(w http.ResponseWriter, r *http.Request) {
	...
	gLogger.InfoContext(r.Context(), "CreateCompany in CreateCompany.")
	if ccErr != nil {
		gLogger.WarnContext(r.Context(), "[company/CreateCompany/ServerHTTP] [ComService.CreateCompany: %s]", ccErr.Detail())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
	ch.Response(r.Context(), gLogger, w, nil, comView)
...
func (ch *CompanyHandlers) UpdateCompany(w http.ResponseWriter, r *http.Request) {
	...
	err := ch.HttpRequestParse(r, params)
	if err != nil {
		gLogger.ErrorContext(r.Context(), "[company/UpdateCompany] [HttpRequestParse: %v]", err)
		ccErr := service.NewError(service.ErrCompany, service.ErrMalformed, service.ErrNull, err.Error())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
	...
	if ccErr != nil {
		gLogger.WarnContext(r.Context(), "[company/UpdateCompany/ServerHTTP] [ComService.UpdateCompanyById: %s]", ccErr.Detail())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
...
func (ch *CompanyHandlers) DeleteCompany(w http.ResponseWriter, r *http.Request) {
	...
	err := ch.HttpRequestParse(r, params)
	if err != nil {
		gLogger.ErrorContext(r.Context(), "[company/DeleteCompany] [HttpRequestParse: %v]", err)
		ccErr := service.NewError(service.ErrCompany, service.ErrMalformed, service.ErrNull, err.Error())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
	...
	if ccErr != nil {
		gLogger.WarnContext(r.Context(), "[company/DeleteCompany/ServerHTTP] [ComService.DeleteCompanyByID: %s]", ccErr.Detail())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
	ch.Response(r.Context(), gLogger, w, nil, nil)
...
func (ch *CompanyHandlers) AssociatedCompanyGroup(w http.ResponseWriter, r *http.Request) {
	...
	err := ch.HttpRequestParse(r, params)
	if err != nil {
		gLogger.ErrorContext(r.Context(), "[company/AssociatedCompanyGroup] [HttpRequestParse: %v]", err)
		ccErr := service.NewError(service.ErrCompany, service.ErrMalformed, service.ErrNull, err.Error())
		ch.Response(r.Context(), gLogger, w, ccErr, nil)
		return
	}
